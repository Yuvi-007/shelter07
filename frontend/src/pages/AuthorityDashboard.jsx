  ...
  return (
    <div className="page">
      ...
      {auth?.user?.role === 'admin' && (
        <div className="admin-alert-banner is-success" style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
          <span>
            <strong>Administrator Account:</strong> Access your full administration workspace with Manage Users, Manage Shelters, Manage Role Requests, and Manage Disasters.
          </span>
          <Link to="/admin" className="btn accent" style={{ padding: '6px 14px', fontSize: '13px', textDecoration: 'none' }}>
